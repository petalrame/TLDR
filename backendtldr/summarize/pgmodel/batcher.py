...
class Batcher(object):
    ...
    def __init__(self, data_path, vocab, hps, single_pass, article=None):
        ...
        # this is a sring sperated by a space
        if article:
            self._article = ' '.join(article)
        else:
            self._article = None
        self._vocab = vocab
        self._hps = hps
